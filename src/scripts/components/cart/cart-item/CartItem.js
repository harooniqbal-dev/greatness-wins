...
const CartItem = ({
    ...
    return (
        <li className="cart__list-item flex mb-2 last:mb-0 pr-3 relative js-cart-list-item">
            <a href={url} className="cart__list-item-link w-24 h-24 bg-alabaster">
                {featured_image.url ? (
            ...
            <div className="flex-1 pt-3 pb-2 ml-6 text-sm flex flex-col items-stretch">
                <h3 className="font-semibold text-xxs flex justify-between">
                ...
                <div className="flex justify-between items-end mt-auto">
                    ...
                    <button
                        ...
                        type="button"
                        className="uppercase underline font-semibold text-xxs leading-none transition-colors link-indicator"
                    >
                        Remove
                    </button>
                </div>
